...
export function GiftIcon({ size = 16, ...p }: IconProps) {
  return (
    <svg {...base(size, p)}>
...
export function HeartIcon({ size = 16, filled = false, ...p }: IconProps & { filled?: boolean }) {
  return (
    <svg {...base(size, p)}>
      <path
...
export function SettingsIcon({ size = 14, ...p }: IconProps) {
  return (
    <svg {...base(size, p)}>
...
export function BookIcon({ size = 16, ...p }: IconProps) {
  return (
    <svg {...base(size, p)}>
...
export function NewsIcon({ size = 16, ...p }: IconProps) {
  return (
    <svg {...base(size, p)}>
...
export function BriefcaseIcon({ size = 16, ...p }: IconProps) {
  return (
    <svg {...base(size, p)}>
...
export function CoinsIcon({ size = 16, ...p }: IconProps) {
  return (
    <svg {...base(size, p)}>
...
export function ClipboardIcon({ size = 14, ...p }: IconProps) {
  return (
    <svg {...base(size, p)}>
...
export function StarIcon({ size = 16, filled = true, ...p }: IconProps & { filled?: boolean }) {
  return (
    <svg {...base(size, p)}>
      <path
...
export function TvIcon({ size = 16, ...p }: IconProps) {
  return (
    <svg {...base(size, p)}>
...
export function ChartIcon({ size = 16, ...p }: IconProps) {
  return (
    <svg {...base(size, p)}>
...
export function DollarSwapIcon({ size = 16, ...p }: IconProps) {
  return (
    <svg {...base(size, p)}>
      <path d="M3 8h13l-3-3" />
      <path d="M21 16H8l3 3" />
...
export function BitcoinIcon({ size = 16, ...p }: IconProps) {
  return (
    <svg {...base(size, p)}>
...
export function PromoIcon({ size = 14, ...p }: IconProps) {
  return (
    <svg {...base(size, p)}>
